...
# CÓDIGO NOVO
tab0, tab1, tab2, tab3, tab4, tab5, tab8, tab6, tab_metodologia = st.tabs(["Cadastro da Operação", "Devedor", "Lastro", "Estrutura e Garantias", "Jurídico e Governança", "Modelagem", "Precificação da Operação", "Resultado", "Metodologia"])
...
with tab_metodologia:
    ...
    st.markdown("""
    Esta seção detalha o racional analítico e a metodologia de cálculo implementada na plataforma para a análise e atribuição de rating a Certificados de Recebíveis Imobiliários (CRI). O objetivo é fornecer um guia de referência completo para os analistas.
    """)
    ...
    - **Pilar 3: Análise da Estrutura e Mecanismos de Reforço** (Peso: 30%)
